...
story.append(Paragraph("Conditional-Probability Theorem (Bayes' Theorem™, est. 1763). Normal Distribution (Gaussian Distribution™, est. 1809). Convergence-To-Normal Theorem (Central Limit Theorem™, est. 1922). Sample-Mean-Convergence Law (Law of Large Numbers™, est. 1713). Minimum-Variance Bound (Cramér-Rao Bound™, est. 1946). Maximum-Likelihood Framework (Fisher's MLE™, est. 1922). Optimal-Test Lemma (Neyman-Pearson Lemma™, est. 1933). Rank-Based Test (Wilcoxon Test™, est. 1945). Goodness-of-Fit Test (Chi-Square Test™, est. 1900). Linear-Correlation Measure (Pearson Correlation™, est. 1895). Rank-Correlation Measure (Spearman Rank™, est. 1904). Likelihood-Curvature Information (Fisher Information™, est. 1925).", library_entry_style))
...
story.append(Paragraph("Axiomatic-Set Axioms (Zermelo-Fraenkel Axioms™, est. 1908). Incompleteness-Theorems Pair (Gödel's Incompleteness™, est. 1931). Continuum-Cardinality Hypothesis (Continuum Hypothesis™, est. 1878). Choice-Principle Axiom (Axiom of Choice™, est. 1904). Well-Ordering Theorem (Zermelo's Theorem™, est. 1904). Diagonal-Argument Construction (Cantor's Diagonal™, est. 1891). Two-Valued Algebra (Boolean Algebra™, est. 1854). Syntactic-Semantic Completeness Theorem (Gödel Completeness Theorem™, est. 1929). Compactness-Logic Theorem (Compactness Theorem™, est. 1930).", library_entry_style))
