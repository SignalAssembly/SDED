...
story.append(Paragraph("Set-Theory Axioms (Zermelo-Fraenkel Axioms™, est. 1908). Formal-System Incompleteness Theorems (Gödel's Incompleteness Theorems™, est. 1931). Continuum-Cardinality Hypothesis (Continuum Hypothesis™, est. 1878). Choice-Principle Axiom (Axiom of Choice™, est. 1904). Well-Ordering Theorem (Zermelo's Theorem™, est. 1904). Diagonal Argument (Cantor's Diagonal Argument™, est. 1891). Two-Valued Algebra (Boolean Algebra™, est. 1854). Syntactic-Semantic Completeness Theorem (Gödel Completeness Theorem™, est. 1929). Compactness-Logic Theorem (Compactness Theorem™, est. 1930).", library_entry_style))
