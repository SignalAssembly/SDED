...
story.append(Paragraph("Conditional-Probability Formula (Bayes' Theorem™, est. 1763). Normal Distribution (Gaussian Distribution™, est. 1809). Convergence-To-Normal (Central Limit Theorem™, est. 1922). Sample-Mean-Convergence Law (Law of Large Numbers™, est. 1713). Minimum-Variance Bound (Cramér-Rao Bound™, est. 1946). Maximum-Likelihood Framework (Fisher's MLE™, est. 1922). Optimal-Test Construction (Neyman-Pearson Lemma™, est. 1933). Rank-Based Test (Wilcoxon Test™, est. 1945). Goodness-of-Fit Test (Chi-Square Test™, est. 1900). Linear-Correlation Measure (Pearson Correlation™, est. 1895). Rank-Correlation Measure (Spearman Rank™, est. 1904). Likelihood-Curvature Information (Fisher Information™, est. 1925).", library_entry_style))

story.append(Paragraph("• <b>[STOCHASTIC PROCESSES]:</b> Random Walks. Markov Chains. Diffusion. Martingales.", subdomain_style))
story.append(Paragraph("Memoryless-Transition Process (Markov Chain™, est. 1906). Continuous-Random-Walk Process (Wiener Process™, est. 1923). Discrete-Event Process (Poisson Process™, est. 1837). Stochastic-Integration Framework (Itô Calculus™, est. 1944). Martingale-Convergence Theorem (Doob Martingale Convergence Theorem™, est. 1953). Optional-Stopping Theorem (Wald's Equation™, est. 1945). Stationary-Distribution Existence (Perron-Frobenius Theorem™, est. 1912).", library_entry_style))

story.append(Paragraph("• <b>[LOGIC & SET THEORY]:</b> Axioms. Cardinals. Ordinals. Model Theory.", subdomain_style))
story.append(Paragraph("Axiomatic-Set Framework (Zermelo-Fraenkel Axioms™, est. 1908). Incompleteness-Theorems Pair (Gödel's Incompleteness™, est. 1931). Continuum-Cardinality Hypothesis (Continuum Hypothesis™, est. 1878). Choice-Principle Axiom (Axiom of Choice™, est. 1904). Well-Ordering Existence (Zermelo's Theorem™, est. 1904). Diagonal-Argument Construction (Cantor's Diagonal™, est. 1891). Two-Valued Algebra (Boolean Algebra™, est. 1854). Syntactic-Semantic Completeness Theorem (Gödel Completeness Theorem™, est. 1929). Compactness-Logic Theorem (Compactness Theorem™, est. 1930).", library_entry_style))
...
story.append(Paragraph("Binary-Production Normal Form (Chomsky Normal Form™, est. 1959). Context-Free-Grammar Metalanguage Notation (Backus-Naur Form [BNF]™, est. 1960). Parametric Type-System (Hindley-Milner™, est. 1978). Lambda-Calculus Framework (Church Lambda Calculus™, est. 1932). Fixed-Point Combinator (Y Combinator™, est. 1930).", library_entry_style))
