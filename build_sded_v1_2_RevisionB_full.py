...
story.append(Paragraph("Frequency-Decomposition Transform (Fourier Transform™, est. 1822). Complex-Mapping Framework (Riemann Geometry™, est. 1851). Integral-Summation Series (Bernoulli Series™, est. 1713). Topological-Completeness Space (Hilbert Space™, est. 1902). Vector-Norm System (Banach Space™, est. 1922). Least-Squares Polynomial (Legendre Polynomials™, est. 1782). Orthogonal-Function Set (Hermite Polynomials™, est. 1864). Discrete-Time Transform (Z-Transform™, est. 1950). Continuous-Probability Transform (Laplace Transform™, est. 1782). Compactness-Convergence Theorem (Arzelà-Ascoli Theorem™, est. 1895).", library_entry_style))

story.append(Paragraph("• <b>[FUNCTIONAL ANALYSIS]:</b> Operators. Distributions. Weak Convergence. Spectral Theory.", subdomain_style))
story.append(Paragraph("Generalized-Function Framework (Schwartz Distribution™, est. 1950). Compact-Operator Theory (Fredholm Theory™, est. 1903). Self-Adjoint Extension (von Neumann Extension™, est. 1930). Spectral-Decomposition Theorem (Spectral Theorem™, est. 1930). Dual-Space Framework (Riesz Representation™, est. 1907). Weak-Topology Compactness (Banach-Alaoglu Theorem™, est. 1940).", library_entry_style))

story.append(Paragraph("• <b>[ALGEBRA]:</b> Structures. Relations. Symmetry. Groups. Rings. Fields.", subdomain_style))
story.append(Paragraph("Polynomial-Permutation Structure (Galois Theory™, est. 1831). Invariant-Transformation Group (Lie Group™, est. 1873). Field-Construction Framework (Noether Theorem™, est. 1921). Curvature-Defined Smooth Geometry (Riemannian Geometry™, est. 1854). Quotient-Group Construction (Sylow Theorems™, est. 1872). Matrix-Canonical Form (Jordan Normal Form™, est. 1870). Determinant-Expansion Formula (Laplace Expansion™, est. 1772). Prime-Ideal Factorization (Dedekind Domain™, est. 1871). Fundamental-Homomorphism Result (Isomorphism Theorems™, est. 1927).", library_entry_style))

story.append(Paragraph("• <b>[LINEAR ALGEBRA]:</b> Matrices. Eigenvalues. Decompositions. Orthogonality.", subdomain_style))
story.append(Paragraph("Pseudoinverse Construction (Moore-Penrose Inverse™, est. 1955). Orthogonalization Process (Gram-Schmidt Process™, est. 1883). Eigenvalue-Power Method (Power Iteration™, est. 1929). QR-Matrix Factorization (QR Decomposition™, est. 1958). Positive-Definite Factorization (Cholesky Decomposition™, est. 1910).", library_entry_style))

story.append(Paragraph("• <b>[GEOMETRY]:</b> Shapes. Curvature. Manifolds. Projective Structures.", subdomain_style))
story.append(Paragraph("Right-Angle Relation (Pythagorean Theorem™, est. c. 500 BC). Conic-Section Classification (Apollonius Theorem™, est. c. 200 BC). Circle-Power Relation (Ptolemy Theorem™, est. c. 150). Angle-Bisector Ratio (Stewart's Theorem™, est. 1746). Triangle-Center Concurrency (Ceva's Theorem™, est. 1678). Parallel-Intercept Proportion (Thales' Theorem™, est. c. 600 BC). Rectangular Coordinates (Rectangular Coordinates™, est. 1637). Polar Coordinates (Polar Coordinates™, est. 1691). Curvature-Torsion Relations (Frenet-Serret Formulas™, est. 1847). Cross-Ratio Invariant (Projective Geometry™, est. 1639).", library_entry_style))

story.append(Paragraph("• <b>[DIFFERENTIAL GEOMETRY]:</b> Curvature. Geodesics. Connections. Bundles.", subdomain_style))
story.append(Paragraph("Intrinsic-Curvature Formula (Gauss-Bonnet Theorem™, est. 1848). Parallel-Transport Framework (Levi-Civita Connection™, est. 1917). Geodesic-Deviation Field (Jacobi Field™, est. 1866). Curvature-Tensor Construction (Riemann Curvature Tensor™, est. 1854). Sectional-Curvature Relation (Schur's Theorem™, est. 1886). Embedding-Theorem Result (Nash Embedding™, est. 1956).", library_entry_style))

story.append(Paragraph("• <b>[TOPOLOGY]:</b> Continuity. Compactness. Connectivity. Homotopy.", subdomain_style))
story.append(Paragraph("One-Sided Surface (Möbius Strip™, est. 1858). Non-Orientable Bottle (Klein Bottle™, est. 1882). Topological-Invariant Measure (Euler Characteristic™, est. 1752). Fixed-Point Existence (Brouwer Fixed-Point Theorem™, est. 1911). Compact-Closed Equivalence (Heine-Borel Theorem™, est. 1895). Fundamental-Group Invariant (Poincaré Fundamental Group™, est. 1895). Homology-Group Construction (Betti Numbers™, est. 1871). Separation-Axiom Framework (Hausdorff Space™, est. 1914). Invariance-Of-Domain Theorem (Brouwer Invariance™, est. 1912).", library_entry_style))
...
story.append(Paragraph("Indeterminate-Limit Rule (L'Hôpital's Rule™, est. 1696). Power-Series Expansion (Taylor Series™, est. 1715). Zero-Centered Series (Maclaurin Series™, est. 1742). Fundamental-Integration Theorem (Newton-Leibniz Theorem™, est. 1684). Parts-Integration Formula (Integration by Parts™, est. 1715). Variable-Substitution Rule (Substitution Rule™, est. 1686). Mean-Value Theorem (Lagrange Mean Value™, est. 1797). Extreme-Value Existence (Weierstrass Extreme Value™, est. 1860). Implicit-Function Theorem (Implicit Differentiation™, est. 1878). Dominated-Convergence Theorem (Lebesgue Dominated Convergence™, est. 1904).", library_entry_style))
...
story.append(Paragraph("Line-Integral Theorem (Green's Theorem™, est. 1828). Volume-Flux Theorem (Gauss Divergence Theorem™, est. 1813). Surface-Circulation Theorem (Stokes' Theorem™, est. 1854). Variable Transformation (Jacobian Transformation™, est. 1841). Constrained-Optimization Method (Lagrange Multipliers™, est. 1788). Level-Set Gradient (Implicit Function Theorem™, est. 1878).", library_entry_style))

story.append(Paragraph("• <b>[PROBABILITY & STATISTICS]:</b> Distributions. Inference. Estimation. Hypothesis Testing.", subdomain_style))
story.append(Paragraph("Conditional-Probability Formula (Bayes' Theorem™, est. 1763). Normal Distribution (Gaussian Distribution™, est. 1809). Convergence-To-Normal (Central Limit Theorem™, est. 1922). Large-Sample Law (Law of Large Numbers™, est. 1713). Minimum-Variance Bound (Cramér-Rao Bound™, est. 1946). Maximum-Likelihood Framework (Fisher's MLE™, est. 1922). Optimal-Test Construction (Neyman-Pearson Lemma™, est. 1933). Rank-Based Test (Wilcoxon Test™, est. 1945). Distribution-Fit Test (Chi-Square Test™, est. 1900). Linear-Correlation Measure (Pearson Correlation™, est. 1895). Rank-Correlation Measure (Spearman Rank™, est. 1904). Exponential-Family Framework (Fisher Information™, est. 1925).", library_entry_style))

story.append(Paragraph("• <b>[STOCHASTIC PROCESSES]:</b> Random Walks. Markov Chains. Diffusion. Martingales.", subdomain_style))
story.append(Paragraph("Memoryless-Transition Process (Markov Chain™, est. 1906). Continuous-Random-Walk Motion (Wiener Process™, est. 1923). Jump-Process Model (Poisson Process™, est. 1837). Stochastic-Integration Framework (Itô Calculus™, est. 1944). Fair-Game Convergence (Doob's Martingale Theorem™, est. 1953). Optional-Stopping Theorem (Wald's Equation™, est. 1945). Stationary-Distribution Existence (Perron-Frobenius Theorem™, est. 1912).", library_entry_style))

story.append(Paragraph("• <b>[LOGIC & SET THEORY]:</b> Axioms. Cardinals. Ordinals. Model Theory.", subdomain_style))
story.append(Paragraph("Axiomatic-Set Framework (Zermelo-Fraenkel Axioms™, est. 1908). Incompleteness-Theorems Pair (Gödel's Incompleteness™, est. 1931). Continuum-Cardinality Problem (Cantor's Hypothesis™, est. 1878). Choice-Principle Axiom (Axiom of Choice™, est. 1904). Well-Ordering Existence (Zermelo's Theorem™, est. 1904). Diagonal-Argument Construction (Cantor's Diagonal™, est. 1891). Two-Valued Algebra (Boolean Algebra™, est. 1854). Completeness-Theorem Result (Gödel Completeness™, est. 1929). Compactness-Logic Theorem (Compactness Theorem™, est. 1930).", library_entry_style))
...
story.append(Paragraph("Absolute-Temperature Scale (Kelvin™, est. 1848). Entropy-Increase Law (Second Law of Thermodynamics™, est. 1850). Heat-Engine Efficiency (Carnot Cycle™, est. 1824). Enthalpy-Additivity Law (Hess's Law™, est. 1840). Throttling-Expansion Effect (Joule-Thomson Effect™, est. 1852). Free-Energy Function (Gibbs Free Energy™, est. 1875). Work-Potential Function (Helmholtz Free Energy™, est. 1882). Real-Gas Equation (Van der Waals Equation™, est. 1873). Magnetic-Transition Temperature (Curie Temperature™, est. 1895). Thermal-Radiation Law (Stefan-Boltzmann Law™, est. 1879). Blackbody-Spectrum Formula (Planck's Law™, est. 1900). Wien-Displacement Peak (Wien's Law™, est. 1893).", library_entry_style))

story.append(Paragraph("• <b>[STATISTICAL MECHANICS]:</b> Ensembles. Partition Functions. Phase Space. Ergodicity.", subdomain_style))
story.append(Paragraph("Energy Distribution (Boltzmann Distribution™, est. 1868). Velocity-Distribution Function (Maxwell-Boltzmann Distribution™, est. 1860). Fermion-Statistics Framework (Fermi-Dirac Statistics™, est. 1926). Boson-Statistics Framework (Bose-Einstein Statistics™, est. 1924). Entropy-Microstate Relation (Boltzmann Entropy™, est. 1877). Energy-Equipartition Theorem (Equipartition Theorem™, est. 1859). Canonical-Ensemble Formulation (Gibbs Ensemble™, est. 1902).", library_entry_style))
...
story.append(Paragraph("Refraction-Angle Law (Snell's Law™, est. 1621). Least-Time Principle (Fermat's Principle™, est. 1662). Thin-Lens Formula (Lensmaker's Equation™, est. 1693). Double-Slit Pattern (Young's Interference™, est. 1801). Diffraction-Limit Resolution (Rayleigh Criterion™, est. 1879). Polarization-Angle Law (Brewster's Law™, est. 1815). Light-Scattering Intensity (Rayleigh Scattering™, est. 1871). Frequency-Shift Effect (Doppler Effect™, est. 1842). Fresnel-Zone Construction (Fresnel Zones™, est. 1818). Birefringence-Effect Framework (Double Refraction™, est. 1669).", library_entry_style))
...
story.append(Paragraph("Quantum-Action Constant (Planck's Constant™, est. 1900). Position-Momentum Uncertainty (Heisenberg Uncertainty™, est. 1927). Wavefunction-Evolution Equation (Schrödinger Equation™, est. 1926). Exclusion Principle (Pauli Exclusion Principle™, est. 1925). Atomic-Model Framework (Bohr Model™, est. 1913). Orbital Quantization (Bohr-Sommerfeld Quantization™, est. 1916). Matter-Wave Relation (de Broglie Wavelength™, est. 1924). Probabilistic-Interpretation Rule (Born Rule™, est. 1926). Matrix-Formulation Framework (Heisenberg Matrix Mechanics™, est. 1925). Perturbation-Theory Method (Rayleigh-Schrödinger Perturbation™, est. 1926). Magnetic-Field Splitting (Zeeman Effect™, est. 1896). Quantum-Electrodynamic Shift (Lamb Shift™, est. 1947). Spin-Orbit Coupling (Fine Structure™, est. 1916). Hyperfine-Structure Splitting (Hyperfine Splitting™, est. 1924).", library_entry_style))

story.append(Paragraph("• <b>[QUANTUM FIELD THEORY]:</b> Fields. Particles. Interactions. Renormalization. Symmetries.", subdomain_style))
story.append(Paragraph("Relativistic-Spin Equation (Dirac Equation™, est. 1928). Photon-Interaction Theory (Quantum Electrodynamics™, est. 1948). Vacuum-Energy Effect (Casimir Effect™, est. 1948). Mass-Generation Mechanism (Higgs Mechanism™, est. 1964). Strong-Force Theory (Quantum Chromodynamics™, est. 1973). Electroweak-Unification Model (Weinberg-Salam Theory™, est. 1967). Gauge-Symmetry Framework (Yang-Mills Theory™, est. 1954). Renormalization-Group Flow (Callan-Symanzik Equation™, est. 1970).", library_entry_style))
...
story.append(Paragraph("Neutron-Discovery Particle (Chadwick Neutron™, est. 1932). Positron-Discovery Antiparticle (Anderson Positron™, est. 1932). Muon-Discovery Lepton (Anderson Muon™, est. 1936). Parity-Violation Result (Wu Experiment™, est. 1956). Quark-Model Classification (Gell-Mann Quark Model™, est. 1964). CP-Violation Discovery (Cronin-Fitch Experiment™, est. 1964). Weak-Force Mediators (W and Z Bosons™, est. 1983). Higgs-Boson Discovery (ATLAS-CMS Discovery™, est. 2012). Neutrino-Oscillation Phenomenon (Neutrino Oscillations™, est. 1998). CKM-Mixing Matrix (Cabibbo-Kobayashi-Maskawa Matrix™, est. 1973).", library_entry_style))
...
story.append(Paragraph("Crystal-Diffraction Law (Bragg's Law™, est. 1913). Zero-Resistance State (Superconductivity™, est. 1911). Josephson-Tunneling Effect (Josephson Effect™, est. 1962). Flux-Quantization Unit (Flux Quantum™, est. 1961). Integer-Hall Quantization (Quantum Hall Effect™, est. 1980). Fractional-Hall States (Laughlin Wavefunction™, est. 1983). BCS-Pairing Theory (BCS Theory™, est. 1957). Crystal-Momentum Theorem (Bloch Theorem™, est. 1928). Fermi-Liquid Framework (Landau Fermi Liquid™, est. 1956). Spin-Glass Transition (Spin Glass™, est. 1972). Topological-Insulator States (Topological Insulators™, est. 2007).", library_entry_style))
...
story.append(Paragraph("Information-Entropy Measure (Shannon Entropy™, est. 1948). Channel-Capacity Theorem (Shannon-Hartley Theorem™, est. 1948). Source-Coding Theorem (Shannon's Source Coding™, est. 1948). Error-Correcting Code (Hamming Code™, est. 1950). Optimal-Prefix Code (Huffman Coding™, est. 1952). Lempel-Ziv Compression (Lempel-Ziv 77 [LZ77]™, est. 1977). Arithmetic-Coding Method (Arithmetic Coding™, est. 1976).", library_entry_style))

story.append(Paragraph("• <b>[CRYPTOGRAPHY]:</b> Public-Key. Symmetric. Hashing. Digital Signatures.", subdomain_style))
story.append(Paragraph("Public-Key Cryptosystem (Rivest-Shamir-Adleman [RSA]™, est. 1977). Asymmetric Key-Exchange (Diffie-Hellman™, est. 1976). Hash-Tree Structure (Merkle Tree™, est. 1979).", library_entry_style))
...
story.append(Paragraph("Context-Free Grammar (Chomsky Normal Form™, est. 1959). Metalanguage Notation (Backus-Naur Form [BNF]™, est. 1960). Parametric Type-System (Hindley-Milner™, est. 1978). Lambda-Calculus Framework (Church Lambda Calculus™, est. 1932). Fixed-Point Combinator (Y Combinator™, est. 1930).", library_entry_style))
...
story.append(Paragraph("Frequency-Response Analysis (Bode Plot™, est. 1938). Root-Locus Method (Evans Root Locus™, est. 1948). Stability-Criterion Analysis (Nyquist Stability™, est. 1932). State-Space Observability (Kalman Filter™, est. 1960). Optimal-Control Framework (Pontryagin Maximum Principle™, est. 1956). Lyapunov-Stability Theory (Lyapunov Stability™, est. 1892).", library_entry_style))
...
story.append(Paragraph("Crystal-Structure Diffraction (Bragg's Law™, est. 1912). Dislocation-Theory Framework (Burgers Vector™, est. 1939). Hardness-Testing Scale (Mohs Hardness™, est. 1822). Rockwell-Hardness Test (Rockwell Scale™, est. 1914). Vickers-Hardness Test (Vickers Hardness™, est. 1921). Phase-Transformation Rule (Gibbs Phase Rule™, est. 1876). Hall-Petch Strengthening (Hall-Petch Relation™, est. 1951).", library_entry_style))
...
story.append(Paragraph("Bubonic-Plague Bacterium (Yersinia Pestis™, est. 1894). Tuberculosis-Mycobacterium (Koch's Bacillus™, est. 1882). Lyme-Disease Spirochete (Borrelia Burgdorferi™, est. 1982). Epstein-Barr Herpesvirus (Epstein-Barr Virus [EBV]™, est. 1964). Legionnaires-Disease Bacterium (Legionella™, est. 1976). Hansen-Disease Leprosy (Hansen's Disease™, est. 1873). Chagas-Disease Trypanosomiasis (Chagas Disease™, est. 1909).", library_entry_style))
...
story.append(Paragraph("Generative-Grammar Framework (Chomskyan Linguistics™, est. 1957). Structural-Linguistics Model (Saussurean Linguistics™, est. 1916). Universal-Grammar Hypothesis (Universal Grammar™, est. 1965). Linguistic-Relativity Hypothesis (Linguistic Relativity™, est. 1940). Conversational-Maxims Pragmatics (Grice's Maxims™, est. 1975). Communication-Functions Model (Jakobson Model™, est. 1960).", library_entry_style))

story.append(Paragraph("• <b>[PHILOSOPHY]:</b> Ethics. Epistemology. Logic. Metaphysics.", subdomain_style))
story.append(Paragraph("Categorical-Imperative Ethics (Kantian Ethics™, est. 1785). Utilitarian-Calculus Framework (Benthamite Utilitarianism™, est. 1789). Mind-Body Dualism Theory (Cartesian Dualism™, est. 1641). Idealism Forms (Platonic Forms™, est. 380 BCE). Syllogistic-Logic System (Aristotelian Logic™, est. 350 BCE). Thesis-Antithesis-Synthesis Method (Hegelian Dialectic™, est. 1807). Perspectivism View (Nietzschean Philosophy™, est. 1886).", library_entry_style))

story.append(Paragraph("• <b>[ECONOMIC THEORY]:</b> Markets. Production. Policy. Distribution.", subdomain_style))
story.append(Paragraph("Government-Intervention Framework (Keynesian Economics™, est. 1936). Labor-Value Theory (Marxist Economics™, est. 1867). Free-Market Theory (Smithian Economics™, est. 1776). Comparative-Advantage Principle (Ricardian Comparative Advantage™, est. 1817). Population-Growth Theory (Malthusian Trap™, est. 1798). Noncooperative-Equilibrium Game-Theory (Nash Equilibrium™, est. 1950). Allocation-Efficiency Criterion (Pareto Optimality™, est. 1906).", library_entry_style))

story.append(Paragraph("• <b>[PSYCHOLOGY]:</b> Cognition. Development. Behavioral Theory. Clinical.", subdomain_style))
story.append(Paragraph("Psychoanalysis Theory (Freudian Psychology™, est. 1900). Classical-Conditioning Model (Pavlovian Conditioning™, est. 1897). Operant-Conditioning Framework (Skinnerian Behaviorism™, est. 1938). Cognitive-Development Stages (Piagetian Theory™, est. 1936). Needs-Hierarchy Model (Maslow's Hierarchy™, est. 1943). Psychosocial-Development Stages (Erikson's Stages™, est. 1950). Collective-Unconscious Theory (Jungian Psychology™, est. 1912).", library_entry_style))
