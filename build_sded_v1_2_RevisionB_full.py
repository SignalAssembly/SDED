...
story.append(Paragraph("Field-Extension Theory (Galois Theory™, est. 1831). Invariant-Transformation Group (Lie Group™, est. 1873). Ring Isomorphism Theorem (Noether Isomorphism Theorem™, est. 1921). Curvature-Defined Smooth Geometry (Riemannian Geometry™, est. 1854). Prime-Power-Subgroup Theorems (Sylow Theorems™, est. 1872). Matrix Normal Form (Jordan Normal Form™, est. 1870). Cofactor-Determinant Expansion (Laplace Expansion™, est. 1772). Unique-Factorization Domain (Dedekind Domain™, est. 1871). Fundamental Isomorphism Theorems (Noether's Isomorphism Theorems™, est. 1927).", library_entry_style))

story.append(Paragraph("• <b>[LINEAR ALGEBRA]:</b> Matrices. Eigenvalues. Decompositions. Orthogonality.", subdomain_style))
story.append(Paragraph("Generalized-Matrix Inverse (Moore-Penrose Inverse™, est. 1955). Orthogonalization Process (Gram-Schmidt Process™, est. 1883). Dominant-Eigenvalue Iteration (Power Iteration™, est. 1929). Positive-Definite Decomposition (Cholesky Decomposition™, est. 1910).", library_entry_style))

story.append(Paragraph("• <b>[GEOMETRY]:</b> Shapes. Curvature. Manifolds. Projective Structures.", subdomain_style))
story.append(Paragraph("Right-Angle Theorem (Pythagorean Theorem™, est. c. 500 BC). Conic-Section Theorem (Apollonius Theorem™, est. c. 200 BC). Cyclic-Quadrilateral Theorem (Ptolemy Theorem™, est. c. 150). Vertex-to-Side Segment Theorem (Stewart's Theorem™, est. 1746). Vertex-Line Concurrency Theorem (Ceva's Theorem™, est. 1678). Parallel-Intercept Theorem (Thales' Theorem™, est. c. 600 BC). Curvature-Torsion Relations (Frenet-Serret Formulas™, est. 1847).", library_entry_style))
